...
export async function GET(req: NextRequest) {
  ...
  // Create a response and extract the socket
  const { socket, response } = await createSocketIOServer(req)
...
async function createSocketIOServer(req: NextRequest) {
  ...
  const response = new Response(null, {
    ...
    headers: {
      Upgrade: "websocket",
      Connection: "Upgrade",
      "Sec-WebSocket-Accept": "...", // In a real implementation, this would be calculated
    },
  })

  return { socket: io.sockets, response }
}
